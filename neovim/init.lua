...
require('packer').startup(function()
  ...
  use 'joshdick/onedark.vim'         -- Theme inspired by Atom TODO: look for other themes
  ...
  use 'hrsh7th/nvim-compe'           -- Autocompletion plugin TODO: CoC??
end)
...
require('telescope').setup {
  defaults = {
    ...
    file_sorter =  require'telescop.sorters'.get_fzy_sorter,
  }
}
