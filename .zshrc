...
export ZSH="/home/moorits/.oh-my-zsh"
...
autoload -U compinit && compinit # Needed for zsh-completitions
...
alias mostusedcmds="history | awk '{print $2}' | sort | uniq -c | sort -rn | head -n 20"
